...
sudo apt-get update
sudo apt-get -y install git git-svn gitk git-gui subversion  libsvn-dev libsvn-java libsvn1 libsvnclientadapter-java libsvnkit-java librxtx-java avrdude
